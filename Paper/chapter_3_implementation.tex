...
\begin{table}[]
    ...
    //book[price$<$10] & \$..book[?(@.price$<$10)] & filter all books cheapier than 10 \\ \hline
    \end{tabular}
...
\begin{lstlisting}[caption={Example mapping rule using all three map types}, label={lst:mapping_rule}, captionpos=b, basicstyle=\small]
...
\begin{lstlisting}[caption={Better bad join result}, label={lst:better_bad_join_result}, captionpos=b, basicstyle=\small]
Student,Sport
Venus,
Tom,
,Tennis
...
\begin{lstlisting}[caption={Example YARRRML mapping for a JSON file}, label={lst:json_file_mapping}, captionpos=b, basicstyle=\small]
prefixes:
    ex: "http://example.com/"
